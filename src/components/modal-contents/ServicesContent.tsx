...
const ServiceCard = ({ title, description, icon, features }) => (
  <div className="group relative overflow-hidden rounded-xl border border-white/10 bg-white/5 p-4 sm:p-6 backdrop-blur-sm transition-all hover:bg-white/10">
    ...
    <div className="relative">
      ...
      <p className="mb-4 text-sm leading-relaxed text-neutral-700 dark:text-white/80">{description}</p>
      <div className="space-y-2">
        {features.map((feature, index) => (
          <div key={index} className="flex items-center text-sm text-neutral-600 dark:text-white/70">
...
const TechnologyBadge = ({ name }) => (
  <div className="rounded-full px-3 py-1 text-sm border border-white/10 bg-white/5 text-neutral-700 dark:text-white/80 backdrop-blur-sm">
    {name}
  </div>
);
  ...
  return (
    <div className="space-y-8 pb-8">
      ...
      <div className="rounded-xl border border-white/10 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 p-4 sm:p-6 backdrop-blur-sm">
        <h2 className="mb-4 text-xl font-bold text-neutral-900 dark:text-white">Natural Enhancement</h2>
      ...
      <div className="rounded-xl border border-white/10 bg-white/5 p-4 sm:p-6 backdrop-blur-sm">
        <h3 className="mb-4 text-lg font-bold text-neutral-900 dark:text-white">Core Technologies</h3>
      ...
      <div className="rounded-xl border border-white/10 bg-white/5 p-4 sm:p-6 backdrop-blur-sm">
        <h3 className="mb-4 text-lg font-bold text-neutral-900 dark:text-white">Service Implementation</h3>
        <div className="relative">
          <div className="absolute left-4 top-0 bottom-0 w-px bg-gradient-to-b from-cyan-500/50 via-blue-500/50 to-transparent" />
          <div className="space-y-6 pl-12">
            <div>
              <h4 className="text-neutral-900 dark:text-white font-medium">1. Understanding Patterns</h4>
              <p className="text-sm text-neutral-600 dark:text-white/60 mt-1">Observing natural workflows and identifying enhancement opportunities</p>
            </div>
            <div>
              <h4 className="text-neutral-900 dark:text-white font-medium">2. Invisible Design</h4>
              <p className="text-sm text-neutral-600 dark:text-white/60 mt-1">Creating systems that enhance without interrupting</p>
            </div>
            <div>
              <h4 className="text-neutral-900 dark:text-white font-medium">3. Natural Integration</h4>
              <p className="text-sm text-neutral-600 dark:text-white/60 mt-1">Implementing solutions that feel like they've always been there</p>
            </div>
            <div>
              <h4 className="text-neutral-900 dark:text-white font-medium">4. Continuous Evolution</h4>
              <p className="text-sm text-neutral-600 dark:text-white/60 mt-1">Adapting and improving based on real-world interactions</p>
            </div>
          </div>
        </div>
      </div>
